    ...
    <>
      ...
      <section>
        <div
          ...
          data-bs-image-src="https://res.cloudinary.com/dwnvcgdsy/image/upload/v1661528469/biddingwebsiteavatars/banner2_jp08xz.webp"
        >
                    ...
                    <ul className="side-menu">
                      ...
                      {user.role == "seller" && (
                        ...
                        >
                          <button
                            className={`side-menu__item ${
                              activeComponent === "waitingApproval"
                                ? "active-component"
                                : ""
                            }`}
                            data-bs-toggle="slide"
