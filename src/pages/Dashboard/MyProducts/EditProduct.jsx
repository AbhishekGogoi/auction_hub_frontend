            ...
            <form method="PUT" onSubmit={handleUpdate}>
              ...
              <div className="card-body">
                <div className="row">
                  ...
                  {productDetails?.furnished && (
                    <div className="col-sm-6 col-md-6">
                      <div className="form-group">
                        ...
                        <input
                          type="text"
                          value={productDetails?.furnished}
                          title="You can not change this"
                    ...
                    <div className="col-sm-6 col-md-6">
                      <div className="form-group">
                        ...
                        <input
                          type="number"
                          name="noOfStoreys"
                          value={productDetails?.noOfStoreys}
                          className="form-control"
                          placeholder="noOfStoreys"
                          onChange={handleChange}
                        />
                      </div>
                    </div>
                  )}
                  {productDetails?.constructionState && (
                    <div className="col-sm-6 col-md-6">
                      <div className="form-group">
                        <label className="form-label">Construction State</label>
                        <input
                          type="text"
                          value={productDetails?.constructionState}
                          title="You can not change construction state"
                          className="form-control editForm-not-editable"
                          placeholder="constructionState"
                          readOnly="readOnly"
                        />
                      </div>
                    </div>
                    ...
                    <div className="col-sm-6 col-md-6">
                      <div className="form-group">
                        ...
                        <input
                          ...
                          title="You can not change product type"
                          className="form-control editForm-not-editable"
                          placeholder="type"
                          readOnly="readOnly"
                        />
                    ...
                    <div className="col-sm-6 col-md-6">
                      <div className="form-group">
                        ...
                        <input
                          ...
                          name="kmsDriven"
                          className="form-control"
                          value={productDetails?.kmsDriven}
                    ...
                    <div className="col-sm-6 col-md-6">
                      <div className="form-group">
                        ...
                        <input
                          ...
                          name="fuelType"
                          className="form-control editForm-not-editable"
                          title="You can not change fuel type"
                    ...
                    <div className="col-sm-6 col-md-6">
                      <div className="form-group">
                        ...
                        <input
                          ...
                          name="floorLevel"
                          className="form-control"
                          value={productDetails?.floorLevel}
                  ...
                  {productDetails?.area && productDetails?.areaUnit && (
                    <div className="col-sm-6 col-md-6">
                      <div className="form-group">
                    ...
                    <div className="col-sm-6 col-md-6">
                      <div className="form-group">
                        ...
                        <input
                          ...
                          title="You can not change product price"
                          style={{
                            cursor: "not-allowed",
                    ...
                    <div className="col-md-6">
                      <div className="form-group">
                        ...
                        <input
                          type="text"
                          className="form-control editForm-not-editable"
                          value={productDetails?.bidTime + " Days"}
