...
const ProductCard = (props) => {
  ...
  const conversationLoading = useSelector(
    (state) => state.conversation.loading
  );
                ...
                {product.bidStatus === "Live" && (
                  <div className="item-card7-overlaytext">
                    <div
                      className={
                        remainingTime > 0
                          ? "text-white badge badge-warning timer-wrapper timer-live"
                          : "text-white badge badge-warning timer-wrapper timer-ended"
                      }
                    >
                    ...
                    <div className="product-actions">
                      ...
                      <Tippy content="Add To Wishlist">
                        <button onClick={addToWishlistHandler}>
                          {added ? <FaHeart /> : <FiHeart />}
                        </button>
                      </Tippy>
                      <Tippy
                        content={`${
                          bidCount <= 1 ? `${bidCount} bid` : `${bidCount} bids`
                        }`}
                      >
                        <button>
                          {" "}
